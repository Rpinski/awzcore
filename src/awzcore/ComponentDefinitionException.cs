...
namespace awzcore
{
	...
	/// <summary>
	/// Exception thrown when the information about a component can't be retrieved.
	/// </summary>
	public class ComponentDefinitionException : Exception
	{
		...
		public ComponentDefinitionException(ErrorReason reason, string text)
			: base(text)
		{
			_reason = reason;
		}
